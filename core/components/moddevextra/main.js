...
function thisTab(thisa){
    ...
    Ext.get( "con-ms-tpl-tab").addClass("x-hide-display");
    Ext.get( "con-ms-templates-tab").addClass("x-hide-display");
    ...
    Ext.get( "ms-tpl-tab").parent().removeClass("x-tab-strip-active");
    Ext.get( "ms-pack-tab").parent().removeClass("x-tab-strip-active");
    Ext.get( "ms-settings-tab").parent().removeClass("x-tab-strip-active");
    Ext.get( "ms-templates-tab").parent().removeClass("x-tab-strip-active");
