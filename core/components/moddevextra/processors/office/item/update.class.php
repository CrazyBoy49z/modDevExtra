...
class modDevExtraOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('moddevextra_item_err_ns');
        }
...
return 'modDevExtraOfficeItemUpdateProcessor';
