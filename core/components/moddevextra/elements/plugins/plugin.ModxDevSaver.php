...
switch ($modx->event->name)
{
	case 'OnTempFormRender':
		$config = array(
			...
			'source' => $modx->getOption('moddevextra.static_media_source').'/template',
			'fileExt' => 'moddevextra.static_template_file_extension',
		);
		break;
	case 'OnChunkFormRender':
		$config = array(
			...
			'source' => $modx->getOption('moddevextra.static_media_source').'/chunk',
			'fileExt' => 'moddevextra.static_chunk_file_extension',
		);
		break;
	case 'OnSnipFormRender':
		$config = array(
			...
			'source' => $modx->getOption('moddevextra.static_media_source').'/snippet',
			'fileExt' => 'moddevextra.static_snippet_file_extension',
		);
		break;
	case 'OnPluginFormRender':
		$config = array(
			...
			'source' => $modx->getOption('moddevextra.static_media_source').'/plugin',
			'fileExt' => 'moddevextra.static_plugin_file_extension',
		);
		break;
	case 'OnTVFormRender':
		$config = array(
			...
			'source' => $modx->getOption('moddevextra.static_media_source').'/tv',
			'fileExt' => 'moddevextra.static_tv_file_extension',
		);
		break;
	default: $config = null;
		break;
...
if ($config)
{
	...
	$modx->regClientStartupScript('<script src="' . $modx->getOption('assets_url') . 'components/moddevextra/inc/js/staticsaver.js"></script>');
